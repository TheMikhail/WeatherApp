    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            WeatherAppTheme {
                ...
                getData("Krasnoyarsk", this, daysList, currentDay)
                    Image(
                    ...
                    Column{
                        MainCard(currentDay, onClickSync = {
                            getData("Krasnoyarsk", this@MainActivity, daysList, currentDay)
                        }, onClickSearch = {
...
private fun getData(city: String, context: Context, daysList: MutableState<List<WeatherModel>>, currentDay: MutableState<WeatherModel>){
    ...
    val sRequest = StringRequest(
        ...
        url,
        {
            ...
            daysList.value = list
            Log.d("getData","Response = $response")

        },
        {
            Log.d("getData","Volley error $it")
        }
    )
    queue.add(sRequest)
}
